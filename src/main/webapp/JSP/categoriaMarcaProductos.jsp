    ...
    <body>
        ...
        <div>
            ...
            <div id="content" class="left_content">
                <div class="principal" id="principalPag">
                    <c:forEach items="${producto.getProductosMarcaCategoria(param.cat,param.mar)}" var="prod">
                        <div>
                            <a href="<%=request.getContextPath()%>/JSP/producto.jsp?idPr=${prod.idProducto}">
                                <img src="<%=request.getContextPath()%>/images/imagenesProductos/${prod.imagenes[0]}" alt="Imagen"/>
                            </a>

                            <p id="des">${prod.denominacion}</p>

                            <div id="pre">
                                <form id="carrito">
                                    <a actionListener="{carrito.agregarLineaPedido(prod, e)}">
                                        Al carrito
                                    </a>
                                </form>
                                ...
                                <p id="mar"><a style="color:grey;" href="<%=request.getContextPath()%>/JSP/marcasProductos.jsp?mar=${prod.idMarca}">${prod.marca}</a></p>
                        </div>
                    </c:forEach>
                </div>
            </div>
